                ...
                {PRIMARY_SERVICES.map((item) => (
                  <li key={item}>
                    ...
                    >
                      ...
                      <span
                        className="text-white/40 group-hover:text-white/90 transition-colors duration-300"
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div>
                    <span className="block text-white/25 mb-1" style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '2px', textTransform: 'uppercase' as const }}>Email</span>
                    <span className="text-white/60 group-hover:text-white/90 transition-colors text-[14px]">contact@shalomcardetailing.com</span>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <span className="block text-white/25 mb-1" style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '2px', textTransform: 'uppercase' as const }}>Phone</span>
                    <span className="text-white/60 group-hover:text-white/90 transition-colors text-[14px]">+91 7718992761</span>
                  </div>
                </a>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl border border-white/[0.04]">
                  ...
                  <div>
                    <span className="block text-white/25 mb-1" style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '2px', textTransform: 'uppercase' as const }}>Address</span>
                    <span className="text-white/50 text-[13px] leading-relaxed block">1st Floor, Skylon Tower, Plot No.37, Sector 19A, Vashi, Navi Mumbai, Maharashtra 400703</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between pointer-events-none">
                    <span
                      ...
                      style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '2px', textTransform: 'uppercase' as const }}
                    >
                      📍 Vashi, Navi Mumbai
                    </span>
                  </div>
      ...
      <div className="border-t border-white/[0.06]" style={{ padding: '32px 0' }}>
        <div className="max-w-[1440px] mx-auto px-8 md:px-16 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <a
                key={name}
                href="#"
                className="group flex items-center gap-3 p-3 rounded-xl border border-white/[0.04] hover:border-[#E50914]/30 hover:bg-[#E50914]/5 transition-all duration-300"
                style={{ textDecoration: 'none' }}
                aria-label={name}
              >
                ...
                <span
                  className="text-white/30 group-hover:text-white/80 transition-colors duration-300 hidden sm:inline"
                  style={{
                    fontFamily: 'var(--font-mono)',
                    fontSize: '10px',
                    fontWeight: 500,
          ...
          <div className="text-center md:text-right flex flex-col gap-2">
            ...
            <p className="text-white/15" style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', letterSpacing: '3px' }}>
